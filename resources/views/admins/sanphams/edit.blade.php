                                        ...
                                        <div class="col-md-4">
                                            <div class="mt-3">
                                                ...
                                                <input type="text" class="form-control" name="ma_san_pham"
                                                    id="ma_san_pham" value="{{ $sanPham->ma_san_pham }}" readonly>
                                                @error('ma_san_pham')
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="number" step="0.01" name="gia"
                                                    ...
                                                    placeholder="Giá bán" value="{{ $sanPham->gia }}">
                                                @error('gia')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="so_luong" id="so_luong" value="{{ $sanPham->so_luong }}">
                                                @error('so_luong')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ $sanPham->ngay_nhap }}" name="ngay_nhap" id="ngay_nhap">
                                                @error('ngay_nhap')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="mt-3">
                                                    ...
                                                    <img src="{{ Storage::url($sanPham->hinh_anh) }}"
                                                        class="img-thumbnail mt-1" alt="Hình ảnh" width="100px">
                                                </div>

                                                <div class="mt-3">
                                                    <label for="mo_ta" class="form-label">Mô tả</label>
                                                    <textarea class="form-control" name="mo_ta" id="mo_ta" rows="4">
                                                        {{-- Hiển thị một chuỗi có chứa ký tự HTML --}}
                                                        {!! $sanPham->mo_ta !!}
                                                    </textarea>
                                                </div>
