        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Thêm mới sinh viên</h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('sinhvien.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('ma_sinh_vien') is-invalid @enderror" id="ma_sinh_vien" name="ma_sinh_vien" value="{{ old('ma_sinh_vien') }}">
                                @error('ma_sinh_vien')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('ten_sinh_vien') is-invalid @enderror" id="ten_sinh_vien" name="ten_sinh_vien" value="{{ old('ten_sinh_vien') }}">
                                @error('ten_sinh_vien')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
